...
public class GraphicPanel extends JPanel {
    ...
    int lastY = 0;
    //step_x = Math.PI;
    ArrayList<IFunction> f = new ArrayList<>();
    ArrayList<ISystem> fsys = new ArrayList<>();
    ArrayList<Point> points = new ArrayList<>();

    public GraphicPanel(IFunction func, Point point1, Point point2, double left, double right) {
        this.x1 = left;
        this.x2 = right;
        this.y1 = left;
        this.y2 = right;
    ...
    public GraphicPanel(IFunction func, double left, double right) {
        this.x1 = left;
        this.x2 = right;
        this.y1 = left;
        this.y2 = right;
    ...
    public GraphicPanel(ArrayList<IFunction> func, ArrayList<Point> points, double left, double right) {
        this.x1 = left;
        this.x2 = right;
        this.y1 = left;
        this.y2 = right;
    ...
    public GraphicPanel(IFunction func, ArrayList<Point> ar, double left, double right) {
        this.x1 = left;
        this.x2 = right;
        this.y1 = left;
        this.y2 = right;
